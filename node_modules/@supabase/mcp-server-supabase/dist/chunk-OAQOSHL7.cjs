"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } async function _asyncNullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return await rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }var L={name:"@supabase/mcp-server-supabase",version:"0.4.0",description:"MCP server for interacting with Supabase",license:"Apache-2.0",type:"module",main:"dist/index.cjs",types:"dist/index.d.ts",sideEffects:!1,scripts:{build:"tsup --clean",prepublishOnly:"npm run build",test:"vitest","test:e2e":"vitest --project e2e","test:unit":"vitest --project unit","generate:management-api-types":"openapi-typescript https://api.supabase.com/api/v1-json -o ./src/management-api/types.ts"},files:["dist/**/*"],bin:{"mcp-server-supabase":"./dist/stdio.js"},exports:{".":{import:"./dist/index.js",types:"./dist/index.d.ts",default:"./dist/index.cjs"}},dependencies:{"@deno/eszip":"^0.84.0","@modelcontextprotocol/sdk":"^1.4.1","@supabase/mcp-utils":"0.2.0","common-tags":"^1.8.2","openapi-fetch":"^0.13.5",zod:"^3.24.1"},devDependencies:{"@ai-sdk/anthropic":"^1.2.9","@electric-sql/pglite":"^0.2.17","@total-typescript/tsconfig":"^1.0.4","@types/common-tags":"^1.8.4","@types/node":"^22.8.6",ai:"^4.3.4","date-fns":"^4.1.0",dotenv:"^16.5.0",msw:"^2.7.3",nanoid:"^5.1.5","openapi-typescript":"^7.5.0","openapi-typescript-helpers":"^0.0.15",prettier:"^3.3.3",tsup:"^8.3.5",tsx:"^4.19.2",typescript:"^5.6.3",vitest:"^2.1.9"}};var _mcputils = require('@supabase/mcp-utils');var _openapifetch = require('openapi-fetch'); var _openapifetch2 = _interopRequireDefault(_openapifetch);var _zod = require('zod');function D(e,o,t={}){return _openapifetch2.default.call(void 0, {baseUrl:e,headers:{Authorization:`Bearer ${o}`,...t}})}var ge=_zod.z.object({message:_zod.z.string()});function i(e,o){if("error"in e){if(e.response.status===401)throw new Error("Unauthorized. Please provide a valid access token to the MCP server via the --access-token flag or SUPABASE_ACCESS_TOKEN.");let{data:t}=ge.safeParse(e.error);throw t?new Error(t.message):new Error(o)}}var de=10,me=.01344;async function R(e,o){let t=await e.GET("/v1/organizations/{slug}",{params:{path:{slug:o}}});i(t,"Failed to fetch organization");let n=await e.GET("/v1/projects");i(n,"Failed to fetch projects");let a=t.data,r=n.data.filter(l=>l.organization_id===o&&!["INACTIVE","GOING_DOWN","REMOVED"].includes(l.status)),s=0;return a.plan!=="free"&&r.length>0&&(s=de),{type:"project",recurrence:"monthly",amount:s}}function w(){return{type:"branch",recurrence:"hourly",amount:me}}function P(e){return Object.fromEntries(e.split(`
`).map(o=>o.split(/=(.*)/)).filter(([o])=>o).map(([o,t])=>[o,_nullishCoalesce(t, () => (""))]))}async function j(e,o){let t=JSON.stringify(e,(r,s)=>s&&typeof s=="object"&&!Array.isArray(s)?Object.keys(s).sort().reduce((l,c)=>(l[c]=s[c],l),{}):s),n=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(t));return btoa(String.fromCharCode(...new Uint8Array(n))).slice(0,o)}function g({description:e,parameters:o,inject:t,execute:n}){if(!t||Object.values(t).every(r=>r===void 0))return _mcputils.tool.call(void 0, {description:e,parameters:o,execute:n});let a=Object.fromEntries(Object.entries(t).filter(([r,s])=>s!==void 0).map(([r])=>[r,!0]));return _mcputils.tool.call(void 0, {description:e,parameters:o.omit(a),execute:r=>n({...r,...t})})}function k({managementApiClient:e,projectId:o}){let t=o;return{create_branch:g({description:"Creates a development branch on a Supabase project. This will apply all migrations from the main project to a fresh branch database. Note that production data will not carry over. The branch will get its own project_id via the resulting project_ref. Use this ID to execute queries and migrations on the branch.",parameters:_zod.z.object({project_id:_zod.z.string(),name:_zod.z.string().default("develop").describe("Name of the branch to create"),confirm_cost_id:_zod.z.string({required_error:"User must confirm understanding of costs before creating a branch."}).describe("The cost confirmation ID. Call `confirm_cost` first.")}),inject:{project_id:t},execute:async({project_id:n,name:a,confirm_cost_id:r})=>{let s=w();if(await j(s)!==r)throw new Error("Cost confirmation ID does not match the expected cost of creating a branch.");let c=await e.POST("/v1/projects/{ref}/branches",{params:{path:{ref:n}},body:{branch_name:a}});if(i(c,"Failed to create branch"),c.data.is_default){await e.PATCH("/v1/branches/{branch_id}",{params:{path:{branch_id:c.data.id}},body:{branch_name:"main"}});let d=await e.POST("/v1/projects/{ref}/branches",{params:{path:{ref:n}},body:{branch_name:a}});return i(d,"Failed to create branch"),d.data}return c.data}}),list_branches:g({description:"Lists all development branches of a Supabase project. This will return branch details including status which you can use to check when operations like merge/rebase/reset complete.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:t},execute:async({project_id:n})=>{let a=await e.GET("/v1/projects/{ref}/branches",{params:{path:{ref:n}}});return a.response.status===422?[]:(i(a,"Failed to list branches"),a.data)}}),delete_branch:_mcputils.tool.call(void 0, {description:"Deletes a development branch.",parameters:_zod.z.object({branch_id:_zod.z.string()}),execute:async({branch_id:n})=>{let a=await e.DELETE("/v1/branches/{branch_id}",{params:{path:{branch_id:n}}});return i(a,"Failed to delete branch"),a.data}}),merge_branch:_mcputils.tool.call(void 0, {description:"Merges migrations and edge functions from a development branch to production.",parameters:_zod.z.object({branch_id:_zod.z.string()}),execute:async({branch_id:n})=>{let a=await e.POST("/v1/branches/{branch_id}/merge",{params:{path:{branch_id:n}},body:{}});return i(a,"Failed to merge branch"),a.data}}),reset_branch:_mcputils.tool.call(void 0, {description:"Resets migrations of a development branch. Any untracked data or schema changes will be lost.",parameters:_zod.z.object({branch_id:_zod.z.string(),migration_version:_zod.z.string().optional().describe("Reset your development branch to a specific migration version.")}),execute:async({branch_id:n,migration_version:a})=>{let r=await e.POST("/v1/branches/{branch_id}/reset",{params:{path:{branch_id:n}},body:{migration_version:a}});return i(r,"Failed to reset branch"),r.data}}),rebase_branch:_mcputils.tool.call(void 0, {description:"Rebases a development branch on production. This will effectively run any newer migrations from production onto this branch to help handle migration drift.",parameters:_zod.z.object({branch_id:_zod.z.string()}),execute:async({branch_id:n})=>{let a=await e.POST("/v1/branches/{branch_id}/push",{params:{path:{branch_id:n}},body:{}});return i(a,"Failed to rebase branch"),a.data}})}}var _commontags = require('common-tags');var H=`-- Adapted from information_schema.columns
...
group by
  ...
  nc.nspname,
  pk.primary_keys
`;var ye=["information_schema","pg_catalog","pg_toast","_timescaledb_internal"];function W(e=[]){let o=_commontags.stripIndent`
    with
      tables as (${z}),
      columns as (${H})
    select
    ...
    from tables
  `;return o+=`
`,e.length>0?o+=`where schema in (${e.map(t=>`'${t}'`).join(",")})`:o+=`where schema not in (${ye.map(t=>`'${t}'`).join(",")})`,o}function q(){return G}var _e=(e,o)=>_commontags.stripIndent`
    COALESCE(
      (
        SELECT
  ...
  `;function $({managementApiClient:e,projectId:o,readOnly:t}){async function n(s,l){let c=await e.POST("/v1/projects/{ref}/database/query",{params:{path:{ref:s}},body:{query:l,read_only:t}});return i(c,"Failed to execute SQL query"),c.data}let a=o;return{list_tables:g({description:"Lists all tables in one or more schemas.",parameters:_zod.z.object({project_id:_zod.z.string(),schemas:_zod.z.array(_zod.z.string()).describe("List of schemas to include. Defaults to all schemas.").default(["public"])}),inject:{project_id:a},execute:async({project_id:s,schemas:l})=>{let c=W(l);return await n(s,c)}}),list_extensions:g({description:"Lists all extensions in the database.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:a},execute:async({project_id:s})=>{let l=q();return await n(s,l)}}),list_migrations:g({description:"Lists all migrations in the database.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:a},execute:async({project_id:s})=>{let l=await e.GET("/v1/projects/{ref}/database/migrations",{params:{path:{ref:s}}});return i(l,"Failed to fetch migrations"),l.data}}),apply_migration:g({description:"Applies a migration to the database. Use this when executing DDL operations. Do not hardcode references to generated IDs in data migrations.",parameters:_zod.z.object({project_id:_zod.z.string(),name:_zod.z.string().describe("The name of the migration in snake_case"),query:_zod.z.string().describe("The SQL query to apply")}),inject:{project_id:a},execute:async({project_id:s,name:l,query:c})=>{if(t)throw new Error("Cannot apply migration in read-only mode.");let d=await e.POST("/v1/projects/{ref}/database/migrations",{params:{path:{ref:s}},body:{name:l,query:c}});return i(d,"Failed to apply migration"),d.data}}),execute_sql:g({description:"Executes raw SQL in the Postgres database. Use `apply_migration` instead for DDL operations.",parameters:_zod.z.object({project_id:_zod.z.string(),query:_zod.z.string().describe("The SQL query to execute")}),inject:{project_id:a},execute:async({query:s,project_id:l})=>await n(l,s)})}}function K(e,o=100){switch(e){case"api":return _commontags.stripIndent`
      ...
      `;case"realtime":return _commontags.stripIndent`
        ...
        order by timestamp desc
        limit ${o}
      `;default:throw new Error(`unsupported log service type: ${e}`)}}function J({managementApiClient:e,projectId:o}){let t=o;return{get_logs:g({description:"Gets logs for a Supabase project by service type. Use this to help debug problems with your app. This will only return logs within the last minute. If the logs you are looking for are older than 1 minute, re-run your test to reproduce them.",parameters:_zod.z.object({project_id:_zod.z.string(),service:_zod.z.enum(["api","branch-action","postgres","edge-function","auth","storage","realtime"]).describe("The service to fetch logs for")}),inject:{project_id:t},execute:async({project_id:n,service:a})=>{let r=a==="branch-action"?new Date(Date.now()-3e5):void 0,s=await e.GET("/v1/projects/{ref}/analytics/endpoints/logs.all",{params:{path:{ref:n},query:{iso_timestamp_start:_optionalChain([r, 'optionalAccess', _2 => _2.toISOString, 'call', _3 => _3()]),sql:K(a)}}});return i(s,"Failed to fetch logs"),s.data}})}}function Y({managementApiClient:e,projectId:o}){let t=o;return{get_project_url:g({description:"Gets the API URL for a project.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:t},execute:async({project_id:n})=>`https://${n}.supabase.co`}),get_anon_key:g({description:"Gets the anonymous API key for a project.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:t},execute:async({project_id:n})=>{let a=await e.GET("/v1/projects/{ref}/api-keys",{params:{path:{ref:n},query:{reveal:!1}}});i(a,"Failed to fetch API keys");let r=_optionalChain([a, 'access', _4 => _4.data, 'optionalAccess', _5 => _5.find, 'call', _6 => _6(s=>s.name==="anon")]);if(!r)throw new Error("Anonymous key not found");return r.api_key}}),generate_typescript_types:g({description:"Generates TypeScript types for a project.",parameters:_zod.z.object({project_id:_zod.z.string()}),inject:{project_id:t},execute:async({project_id:n})=>{let a=await e.GET("/v1/projects/{ref}/types/typescript",{params:{path:{ref:n}}});return i(a,"Failed to fetch TypeScript types"),a.data}})}}var _url = require('url');var _eszip = require('@deno/eszip');var _path = require('path');var A=await _eszip.Parser.createInstance(),Te=_zod.z.object({version:_zod.z.number(),sources:_zod.z.array(_zod.z.string()),sourcesContent:_zod.z.array(_zod.z.string()).optional(),names:_zod.z.array(_zod.z.string()),mappings:_zod.z.string()});async function V(e,o="/"){let t=[];if(e instanceof ReadableStream){let r=e.getReader({mode:"byob"});t=await A.parse(r)}else t=await A.parseBytes(e);await A.load();let n=t.filter(r=>r.startsWith("file://"));return await Promise.all(n.map(async r=>{let s=await A.getModuleSource(r),l=await A.getModuleSourceMap(r),c=_path.relative.call(void 0, o,_url.fileURLToPath.call(void 0, r)),d=new File([s],c,{type:"text/plain"});if(!l)return d;let E=Te.parse(JSON.parse(l)),[h]=_nullishCoalesce(E.sourcesContent, () => ([]));return h?new File([h],c,{type:"application/typescript"}):d}))}function Ae(e,o,t){return`${e}_${o}_${t}`}function Ne(e){return`/tmp/user_fn_${e}/`}var Q=_commontags.codeBlock`
